...
<svelte:head>
  <title>chat.vote/vts login prompt</title>
</svelte:head>
...
<div class="container d-flex justify-content-center align-items-center" style="height: 70%">
  <div class="row">
    ...
    <a
      ...
      href="https://id.twitch.tv/oauth2/authorize?client_id=qn0wimnszbqlwfnszdz3wwfz430eqr&redirect_uri=https://chat.vote/vts/login.html&response_type=token&scope=channel:manage:redemptions"
    >
