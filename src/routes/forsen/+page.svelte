...
<svelte:head>
  <title>chat.vote Forsen</title>
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
  <meta name="description" content="Raffle site for big retard streamer. only works for forsen's chat, check out chat.vote/raffles instead :)" />
  <meta name="keywords" content="twitch, chat, raffle, chatvote, chat.vote" />
  <meta property="og:title" content="chat.vote Forsen" />
  <meta property="og:site_name" content="chat.vote Forsen" />
  <meta property="og:type" content="website" />
  <meta property="og:url" content="https://chat.vote/forsen/" />
  <meta property="og:image" content="https://screenshot.donk.workers.dev/?url=https://chat.vote/forsen" />
  <meta property="og:locale" content="en_US" />
  <meta property="og:description" content="Raffle site for big retard streamer. only works for forsen's chat, check out chat.vote/raffles instead :)" />
</svelte:head>
...
<div class="modal fade" id="restartTier3RaffleModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Are you sure?</h5>
      ...
      <div class="card">
        <div class="card-body bg-body-tertiary rounded">
          ...
          <div class="form-floating d-inline-flex">
            <select class="form-select" id="animationSelect" aria-label="Animation settings">
              <option value="off">Off</option>
              <option selected value="on">On</option>
              <option value="pfp">On (Twitch profile pictures)</option>
            </select>
            <label for="animationSelect">Animation</label>
          </div>

          <h2>Type <span class="notranslate text-success">!join</span> or <span class="notranslate text-success">!ticket 1</span> in chat to join</h2>
          <h4 id="entrants">Entrants: 0</h4>

          <div id="raffleUsersDiv" class="border rounded">
            <ul class="list-group" id="raffleUsers"></ul>
          </div>

          <h5>Winner:</h5>
          <div id="raffleOutput" class="border rounded"></div>
        </div>
      </div>
    </div>
    ...
    <div class="col">
      <div class="card">
        <div class="card-body bg-body-tertiary rounded">
          ...
          <h4 id="entrantsTier3">Entrants: 0</h4>

          <div id="raffleUsersDivTier3" class="border rounded">
            <ul class="list-group" id="raffleUsersTier3"></ul>
          </div>

          <h5>Winner:</h5>
          <div id="raffleOutputTier3" class="border rounded"></div>
        </div>
      </div>
    </div>
    <div class="col-lg-2"></div>
