<script>
  ...
  /**
   * @type {{ darkTheme: any; optionsDiv: any; pollModal: any; captchaModal: any; pollTitle: any; pollTimerValue: any; detect_low: any; detect_high: any; multipleAnswersAllowed: any; results_timer: any; pollTimerUnit: any; results_anyone: any; results_voters: any; results_creator: any; bulkOptions: any; errorDiv: any; pollLinkDiv: any; pollTitleDiv: any; pollOptionsDiv: any; pollSettingsDiv: any; }}
   */
  let elements;
  onMount(async () => {
    elements = {
  ...
  /**
   * @param {{ target: { dataset: { optionId: string; }; value: string; }; key: string; preventDefault: () => void; shiftKey: any; }} event
   */
  ...
  /**
   * @param {{ target: { dataset: { optionId: string; }; }; }} event
   */
...
<style>
  ...
  .option-card {
    margin-top: 5px;
    position: relative;
    animation: card-easein 0.1s ease-in;
  }
