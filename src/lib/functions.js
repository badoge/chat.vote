...
export async function getGlobalTwitchEmotes(largeEmotes = false) {
  let emotes = [];
  try {
...
export async function getGlobalBTTVEmotes(largeEmotes = false) {
  let emotes = [];
...
export async function getGlobalFFZEmotes(largeEmotes = false) {
  let emotes = [];
  try {
...
export async function getGlobal7TVEmotes(largeEmotes = false) {
  let emotes = [];
  try {
 ...
 */
export function numberAndUnitToSeconds(number, unit) {
 ...
 * @returns {number}
 */
export function spotifyReleaseDateToTimestamp(releaseDate, releaseDatePrecision) {
  let date;
